# -*- coding: utf-8 -*-
"""
Created on Tue Nov 19 13:53:26 2019
Nathan Marshall

1D Heat Equation - Metal Rod with Fixed Endpoints and Central Source
"""
#%%
import numpy as np
...
def heat_eqn(u):
    ...
    for i in range(1, num-1):
        if i == 49: #hold the middle point at 1 as a heat source
            continue
        u[i] += du[i] * dt
        
fig, ax = plt.subplots(1,1) #create a figure, line, and axes object
line, = ax.plot([], []) 
ax.set_title('1D Heat Equation with Central Source')   
